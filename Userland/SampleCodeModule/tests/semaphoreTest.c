...
void testSync()
{
  ...
  printf("CREATING PROCESSES WITH SEMAPHORE\n");

  for (i = 0; i < TOTAL_PAIR_PROCESSES; i++)
  {
    char *argv1[] = {"inc process with sem", "1", "1", "10000"};
    createProcess(&inc, 4, argv1, BACKGROUND, NULL);
    char *argv2[] = {"inc process with sem", "1", "-1", "10000"};
    createProcess(&inc, 4, argv2, BACKGROUND, NULL);
  }
}
...
void testNoSync()
{
  ...
  printf("CREATING PROCESSES WITHOUT SEMAPHORE\n");
