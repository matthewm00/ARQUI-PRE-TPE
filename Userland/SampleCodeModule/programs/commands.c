...
void help(int argc, char argv[MAX_ARGUMENTS][BUFFER_SIZE])
{
	...
	printf("\n/user : Cambia el nombre de usuario. Ingrese el nombre como un solo argumento.\n");
	...
	printf("\n/roots : Calculo de raices de una funcion cuadratica. Ingrese los 3 valores de la misma como argumentos.\n");
